...
This mechanism has been integrated into Bitcore-Node-qwc which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/qwcOfficial/insight-api-qwc#web-socket-api](https://github.com/qwcOfficial/insight-api-qwc#web-socket-api)
* API: [https://github.com/qwcOfficial/insight-api-qwc#instantsend-transactions](https://github.com/qwcOfficial/insight-api-qwc#instantsend-transactions)
...
By default, the qwc Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the qwc Core daemon:
