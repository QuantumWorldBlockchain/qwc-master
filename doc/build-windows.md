...
Some notes on how to build qwc Core for Windows.
...
Note that for WSL the qwc Core source path MUST be somewhere in the default mount file system, for
...
way. This will install to `c:\workspace\bitcoin`, for example:
    ...
    make install DESTDIR=/mnt/c/workspace/qwc # or any other folder name you like
...
It's not possible to build the qwc Core code using the win32 version of the Mingw-w64 cross compilers (at least not without
modifying headers in the qwc Core source code).
