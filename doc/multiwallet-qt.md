...
Only requiring some minor changes is qwc.cpp.
...
Changes to qwc.cpp
----------------------
qwc.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
