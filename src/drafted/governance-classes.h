 ...
 *
 *   // network
 *   CqwcNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.qwc.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CqwcNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: qwcNetwork
// //   -- signature requirements : Key1(User)
// class CqwcNetworkVariable : public CGovernanceObject
// {
// private:
