...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all qwc related functionality
...
/*
    ...
    allow endless transaction that would bloat qwc and make it unusable. To
