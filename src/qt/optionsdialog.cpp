    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("qwc-Tan"), QVariant("light"));
    ui->theme->addItem(QString("qwc-Black"), QVariant("drkblue"));
    ui->theme->addItem(QString("qwc-Blue"), QVariant("crownium"));
    ui->theme->addItem(QString("qwc-Chocolate"), QVariant("trad"));
    /* Language selector */
