    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("qwc Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About qwc Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  qwc-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the qwc in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 qwc, 0.1 qwc, 1 qwc and 10 qwc -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("qwc Core is shutting down...") + "<br /><br />" +
